...
function createToken(user) {
    return __awaiter(this, void 0, void 0, function () {
        var tokenRepo, token, accessToken, refreshToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, generateToken_1.default)({ user_id: user.id, username: user.username }, { subject: 'access_token', expiresIn: '15m' })];
                case 3:
                    accessToken = _a.sent();
