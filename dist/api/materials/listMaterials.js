...
function listMaterialsAPI(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var recipe_id, materialRepo, query, materials, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 7, , 8]);
                    if (!recipe_id) return [3 /*break*/, 5];
                    return [4 /*yield*/, server_1.dataSource.getRepository(Material_1.Material)];
                case 2:
                    materialRepo = _a.sent();
                    return [4 /*yield*/, materialRepo
                            .createQueryBuilder('materials')
                            .where('materials.fk_recipe_id = :recipe_id', { recipe_id: recipe_id })
