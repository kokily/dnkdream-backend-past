...
function addRecipeContentAPI(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var id, schema, content, user_id, recipeRepo, recipe, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    recipeRepo = _a.sent();
                    return [4 /*yield*/, recipeRepo.findOneBy({ id: id })];
                case 4:
                    recipe = _a.sent();
                    if (!recipe) {
                        ctx.status = 404;
                    ...
                    return [4 /*yield*/, recipeRepo.update({ id: id }, { content: content, updated_at: new Date() })];
                case 5:
                    _a.sent();
                    ctx.status = 200;
                    return [3 /*break*/, 7];
...
exports.default = addRecipeContentAPI;
