...
function initRecipeAPI(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var schema, _a, title, serving, thumbnail, user_id, recipeRepo, recipe, err_1;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!(0, utils_1.validateBody)(ctx, schema))
                        return [2 /*return*/];
                    _a = ctx.request.body, title = _a.title, serving = _a.serving, thumbnail = _a.thumbnail;
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 5, , 6]);
                ...
                case 3:
                    ...
                    return [4 /*yield*/, recipeRepo.save(recipe)];
                case 4:
                    _b.sent();
                    ctx.body = recipe;
                    return [3 /*break*/, 6];
